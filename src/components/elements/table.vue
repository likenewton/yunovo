  ...
  <div>
    <el-card class="box-card" style="margin-bottom: 20px" shadow="never">
      <el-form :inline="true" :model="formInline" class="demo-form-inline" size="small">
        <el-form-item label="设备筛选器" size="small">
    ...
    <el-card class="box-card clearfix" shadow="never">
      ...
      <el-table ref="multipleTable" @selection-change="changeFun" :data="curTableData" border :default-sort="{prop: 'date', order: 'descending'}" size="mini">
        ...
        <el-table-column fixed="right" label="操作" width="260">
          <template slot-scope="scope">
            <el-button type="text" size="mini" @click="createDisPlan">新建计划</el-button>
            <el-button type="text" size="mini">编辑</el-button>
            <el-button type="text" size="mini">删除</el-button>
            <el-button type="text" size="mini">筛选结果</el-button>
          </template>
        </el-table-column>
      </el-table>
