    ...
    <el-card style="margin-bottom: 20px" shadow="never">
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="130px" class="demo-ruleForm">
        ...
        <el-form-item label="活动时间：" required size="small">
          ...
          <el-col class="line"  style="text-align: center;width: 15px">-</el-col>
          <el-col style="width:215px">
            <el-form-item prop="date2">
              <el-time-picker size="small" placeholder="选择时间" v-model="ruleForm.date2" style="width: 100%;"></el-time-picker>
            </el-form-item>
          </el-col>
        </el-form-item>
        ...
        <el-form-item label="活动性质：" prop="type" size="small">
        ...
        <el-form-item label="活动特殊资源：" prop="resource" size="small">
          <el-radio-group size="small" v-model="ruleForm.resource">
            <el-radio label="线上品牌商赞助"></el-radio>
            <el-radio label="线下场地免费"></el-radio>
          </el-radio-group>
        </el-form-item>
        <el-form-item label="活动形式：" prop="desc" size="small">
