  ...
  <div>
    ...
    <el-card class="box-card clearfix" shadow="never">
      <el-button-group style="margin-bottom: 10px">
        <el-button size="mini" type="primary" icon="el-icon-circle-plus-outline" @click="openDialog('ADD')">推送</el-button>
      ...
      <el-table ref="multipleTable" @selection-change="changeFun" :data="curTableData" border :default-sort="{prop: 'date', order: 'descending'}">
        ...
        <el-table-column show-overflow-tooltip prop="exec" label="匹配算法" min-width="100"></el-table-column>
        <el-table-column show-overflow-tooltip prop="rule" label="规则内容" min-width="150"></el-table-column>
        ...
        <el-table-column show-overflow-tooltip fixed="right" label="操作" width="160">
          <template slot-scope="scope">
            <el-button type="text" size="mini" @click="singleUpdate(scope.$index, scope.row)">修改并推送</el-button>
...
export default {
  ...
  data() {
    return {
      ...
      currentPage: 1,
      choiceTableDate: [],
      tableData: Api.STATIC.tableData3,
      formInline: {
        name: '',
        code: '',
        effect: ''
